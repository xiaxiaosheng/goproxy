...
[![GoDoc](https://godoc.org/github.com/xiaxiaosheng/goproxy?status.svg)](https://godoc.org/github.com/xiaxiaosheng/goproxy)
[![Join the chat at https://gitter.im/xiaxiaosheng/goproxy](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/xiaxiaosheng/goproxy?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
![Status](https://github.com/xiaxiaosheng/goproxy/workflows/Go/badge.svg)
...
Get the latest goproxy from `gopkg.in/xiaxiaosheng/goproxy.v1`.
...
import (
    "github.com/xiaxiaosheng/goproxy"
    "log"
    "net/http"
)
...
[the eavesdropper example](https://github.com/xiaxiaosheng/goproxy/blob/master/examples/goproxy-eavesdropper/main.go#L27)
2. Transparent proxy support for http/https including MITM certificate generation for TLS.  See the [transparent example.](https://github.com/xiaxiaosheng/goproxy/tree/master/examples/goproxy-transparent)
